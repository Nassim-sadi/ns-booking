...
<div class="nsbc-configurator" data-nsbc>
    <div class="nsbc-layout">
        <!-- Step 1: Configuration — packages large, 4 per full-width / 2x2 tight -->
        <section class="nsbc-card nsbc-step" data-step="1">
            ...
            <div class="nsbc-field">
                ...
                <div class="nsbc-packages" data-role="packages">
                    <!-- injected by JS: image top + excerpt below -->
                </div>
            </div>
        ...
        <!-- Step 2: Summary — below selector, above form, always detailed, not sticky -->
        <section class="nsbc-summary nsbc-summary--stacked" data-role="summary">
            <h4 class="nsbc-summary-title"><?php esc_html_e('Summary','ns-booking'); ?></h4>
            <div class="nsbc-summary-body" data-role="summary-body">
                <!-- JS always renders detailed rows, not collapsed placeholder -->
            </div>
