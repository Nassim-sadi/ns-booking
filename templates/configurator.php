...
<div class="nsbc-configurator" data-nsbc>
    <div class="nsbc-layout">
        <!-- Step 1: Configuration — large packages 4 per full-width / 2x2 tight -->
        <section class="nsbc-card nsbc-step" data-step="1">
            ...
            <div class="nsbc-field">
                ...
                <div class="nsbc-packages" data-role="packages">
                    <!-- injected by JS: image top (if enabled) + excerpt below -->
                </div>
            </div>
        ...
        <!-- Lower: form + summary side-by-side desktop, stacked mobile (summary above form) -->
        <div class="nsbc-lower">
